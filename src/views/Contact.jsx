...
function Contact(props) {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <title>Red Nebula - Contact Us </title>
      </Helmet>

      {/*Start Header*/}
      <HeaderNormalTow description={headerContent.description}>{headerContent.title}</HeaderNormalTow>
      ...
      <Container className="section-margin mt-0">
