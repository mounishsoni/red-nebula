...
import { getPortfolioCategoryVideos, getPortfolioVideoData } from "../../api/portfolio/PortfolioVideoData";

const DocumentariesEvents = ({ data }) => {

  const nextData = getPortfolioItem(8);
    const dataPortfolio = getPortfolioCategoryVideos("Documentaries / Events");
...
export default DocumentariesEvents;
